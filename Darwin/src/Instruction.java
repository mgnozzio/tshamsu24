...
public class Instruction {
	...
	public static final int IFLEFT=16;
	/** opcode for the ifenemyright instruction **/
	public static final int IFRIGHT=17;
	/** opcode for the ifmemeq instruction **/
	public static final int IFMEMEQ=18;
	/** opcode for the fetting a copy memory instruction **/
	public static final int SAMEMEME=19;
	...
	public String toString() {
		switch (opcode) {
			...
			case SET:
				return "set "+ address;
			case IFLEFT:
				return "ifleft " + address;
			case IFRIGHT:
				return "ifright " + address;
			case IFMEMEQ:
				return "ifmemeq " + address;
			case SAMEMEME:
				return "samememe " + address;
